...
const CategorizeQ = ({ question }) => {
  return (
    <div className="w-full md:w-1/2 bg-purple-100 rounded-md p-2 mb-8 text-purple-800  gap-2 flex flex-col">
      {question.image ? (
      ...
      <div className="flex flex-col gap-2 mt-2">
        {question.answers[0].map((answers, index) => (
          <div className="flex w-full gap-6 align-middle items-center">
